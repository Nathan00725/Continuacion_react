...
export const ReporteUsuario = () => {
    ...
    return (
        <>
            <h3 style={{ color: 'blue' }}>Reporte de Usuarios</h3>
            <table className="table table-hover" style={{ color: 'blue' }}>
                <thead>
                    <tr>
                ...
                <tbody>
                    {data.map((item) => (
                        <tr key={item.nombre_usuario}>
                            ...
                            <td>
                                <button className='btn btn-danger' onClick={() => { borrarUsuario(item.nombre_usuario) }}>x</button>
                                <button className='btn btn-warning' onClick={() => { editarUsuario(item) }}>e</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
