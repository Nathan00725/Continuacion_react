        ...
        <form onSubmit={deleteHandler}>
            <fieldset>
                ...
                <div className="form-group row" style={{ backgroundColor: '#34495E', padding: '10px', borderRadius: '5px', marginBottom: '15px' }}>
                    <label className="col-sm-2 col-form-label">Id del tipo del arma</label>
                ...
                <button type="submit" className="btn btn-primary w-100" style={{ backgroundColor: '#2980B9', color: '#FFFFFF' }}>Eliminar tipo de arma</button>
                <br/>
                <Link to="/Post_tipoa" style={{ color: '#2980B9' }}>Ingresar Tipo arma</Link>
                <br/>
                <Link to="/Put_tipoa" style={{ color: '#2980B9' }}>Actualizar Tipo de Arma</Link>
            </fieldset>
        </form>
    </div>
);
