...
export const Put_arma = () => {
   ...
   const Id_calibreHandler = (event) => {
     ...
     const PutHandler = async () => {
         ...
         const result = await axios.put(url+ "/" + arma_id ,data);
        ...
        <>
           <div className='container mt-5' style={{ backgroundColor: '#2C3E50', color: '#FFFFFF', padding: '20px', borderRadius: '10px' }}>
                <form onSubmit={PutHandler}>
                    ...
                    <button type="submit" className="btn btn-primary w-100" style={{ backgroundColor: '#2980B9', color: '#FFFFFF' }}>Actualizar el Arma</button>
                    <br/>
                    <Link to="/Post_arma" style={{ color: '#2C3E50' }}>Ingresar el Arma</Link>
                    <br/>
