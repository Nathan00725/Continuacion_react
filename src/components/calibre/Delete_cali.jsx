...
return (
    <div className='container mt-5' style={{ backgroundColor: '#2C3E50', color: '#FFFFFF', padding: '20px', borderRadius: '10px' }}>
        <form onSubmit={deleteHandler}>
            <fieldset>
                <legend style={{ color: '#2980B9' }}>Eliminar el Calibre del arma</legend>
                ...
                <button type="submit" className="btn btn-primary w-100" style={{ backgroundColor: '#2980B9', color: '#FFFFFF' }}>Eliminar el Calibre del arma</button>
                <br/>
                <Link to="/Post_cali" style={{ color: '#2980B9' }}>Ingresar el Calibre del arma</Link>
                <br/>
                <Link to="/Put_cali" style={{ color: '#2980B9' }}>Actualizar el Calibre del arma</Link>
            </fieldset>
        </form>
    </div>
);
